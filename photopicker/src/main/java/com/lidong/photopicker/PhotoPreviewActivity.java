...
public class PhotoPreviewActivity extends AppCompatActivity implements PhotoPagerAdapter.PhotoViewClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setOffscreenPageLimit(3);//预加载页面
...
//        getSupportActionBar().setHomeAsUpIndicator(upArrow);
    ...
    public void updateActionBarTitle() {
        int i=paths.size();
        int z=mViewPager.getCurrentItem()+2;
        ...
        getSupportActionBar().setTitle(getString(R.string.image_index, z,
                i));
