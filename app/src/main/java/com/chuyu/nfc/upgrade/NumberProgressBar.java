...
//    private int totalMovedLength;
    ...
    private void initData() {
        ...
        // 已完成进度条画笔的属性
        paintInit.setColor(Color.parseColor("#00ACEE"));
        ...
        // 大圆画笔
        paintEndBig.setColor(Color.parseColor("#00ACEE"));
        ...
        paintText.setColor(Color.parseColor("#00ACEE"));
