...
import com.chuyu.nfc.tools.Utils;
...
/**
 * Created by Zoello on 2018/12/17.
 */

public class WXShare {

    public static final String APP_ID = "wxfbdfa7d65cda8150";
    ...
    public WXShare shareUrl(int flag,String url,String title,String descroption,Bitmap thumb){
...
//        Bitmap thumb = BitmapFactory.decodeResource(context.getResources(), R.drawable.sharelogo);
