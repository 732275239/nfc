...
/**
 * Created by Zoello on 2018/12/14.
 * 权限请求页适配，不同手机系统跳转到不同的权限请求页
 */

public class PermissionPageUtils {
    private Context mContext; //自己的项目包名
    private String packageName = "com.chuyu.nfc";
...
//        L.e(TAG, "goMiaoMiMainager --- rom : " + rom);
     ...
     * <p>
     * 和Intent
     * open = getPackageManager().getLaunchIntentForPackage("com.yulong.android.security:remote");
     * <p>
     * <p>
     * startActivity(open);
     * /*本质上没有什么区别，
     * 通过Intent open...打开比调用doStartApplicationWithPackageName方法更快，也是android本身提供的方法
     */

    private void goCoolpadMainager() {
        doStartApplicationWithPackageName("com.yulong.android.security:remote"); /*  Intent openQQ = getPackageManager().getLaunchIntentForPackage("com.yulong.android.security:remote");
        startActivity(openQQ);*/
    }

    private void goVivoMainager() {
        doStartApplicationWithPackageName("com.bairenkeji.icaller"); /*   Intent openQQ = getPackageManager().getLaunchIntentForPackage("com.vivo.securedaemonservice");
        startActivity(openQQ);*/
    }
    ...
    private void doStartApplicationWithPackageName(String packagename) {
        ...
        if (resolveinfo != null) { // packageName参数2 = 参数packname
